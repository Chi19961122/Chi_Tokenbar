...
**你的 AI coding 額度電量表 —— 常駐桌面，一眼看懂 Claude Code 和 Codex 還剩多少電。**

<img src="Ai_Assistant/screenshots/island.png" alt="TokenBar 島嶼膠囊" width="360"/>
...
TokenBar 把這件事變成**看一眼就好**：一顆常駐在螢幕右下角的小電池膠囊，像手機電量一樣顯示兩家的剩餘額度。快用完會變黃、鎖定會閃紅、到達警戒線還會跳系統通知。

## 一眼看懂

| 島嶼膠囊（常駐） | 精簡面板 | 完整面板 | 額度詳情 |
|:---:|:---:|:---:|:---:|
| <img src="Ai_Assistant/screenshots/island.png" width="340"/> | <img src="Ai_Assistant/screenshots/panel-compact.png" width="200"/> | <img src="Ai_Assistant/screenshots/panel-full.png" width="200"/> | <img src="Ai_Assistant/screenshots/panel-detail.png" width="200"/> |
...
| `⊟` / `⊞` | 精簡模式 ⇄ 完整模式 |
| `⚙` | 設定（見下表） |
| 系統匣圖示 | 電量膠囊縮圖 + hover 顯示所有額度；右鍵可顯示/隱藏/結束 |
...
完整參數表（更新頻率、狀態機門檻等）見 [Ai_Assistant/CONFIG.md](Ai_Assistant/CONFIG.md)。
