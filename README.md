...
<img src="docs/preview/island.png" alt="Atoll 島嶼膠囊" width="420"/>

*就這顆小膠囊。左邊 Claude（還很健康）、右邊 Codex（週限額鎖了，紅字），右側是現在的燒速。*
...
| 額度面板（暗色） | 用量 · 兩鏡頭（亮色） |
|:---:|:---:|
| <img src="docs/preview/limits.png" width="300"/> | <img src="docs/preview/analytics.png" width="300"/> |
| 每條額度的狀態與重置時間；綠色健康、黃色接近上限、紅色鎖定 | Trends 看時間走勢、Breakdown 看去向 |
