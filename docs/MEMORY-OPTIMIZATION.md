...
> 狀態：**規劃檔 v2.3.1** — **階段 0 instrumentation + 1A + 1B 已提交**；階段 2／3／4／5 待做  
> 日期：2026-07-19  
...
| **1B. Coordinator** | exclusion + coalesce + TTL + queue | 消並行／重複 key 重掃 | 中 | **已提交**（month 衍生 week/today 可選未做） |
